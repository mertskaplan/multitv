...
?> 
            ...
            <div class="mt-2 py-2 text-center position-absolute bottom-0 start-50 translate-middle-x text-bg-dark" style="font-size:.78em; width: 368px;">
                <a href="https://mertskaplan.com" target="_blank" rel="author external" class="link-light text-decoration-none">Mert S. Kaplan</a> tarafından <a href="https://github.com/mertskaplan/multitv/blob/main/LICENSE" rel="license external nofollow noopener" class="link-light text-decoration-none">MIT Lisansı<a> ile geliştirildi | 
                <a href="https://github.com/mertskaplan/multitv" rel="external noopener" class="link-light text-decoration-none">GitHub</a></div>
        </div>
    </div>
